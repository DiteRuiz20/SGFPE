...
export default function PersonalLogin({ navigation }) {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      Alert.alert('Error', error.message || 'Correo o contraseña inválidos');
    }
  };
...
const styles = StyleSheet.create({
  ...
  primary_button: {
    width: '100%', backgroundColor: '#30437A', padding: 15, borderRadius: 8, alignItems: 'center',
    shadowColor: '#30387a', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.5, shadowRadius: 2,
    marginBottom: 15
  },
  secondary_button: {
    width: '100%', backgroundColor: '#3DC9A7', padding: 15, borderRadius: 8, alignItems: 'center',
    shadowColor: '#3dc1ad', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.5, shadowRadius: 2,
  },
  button_text: { color: 'white', fontSize: 16 },
  divider: { width: '100%', height: 2, backgroundColor: '#EAEAEA', marginVertical: 15 },
  orText: { fontSize: 14, color: '#666', backgroundColor: 'white', top: -23 },
  getStarted: { color: '#666', fontSize: 14, marginBottom: 15 },
